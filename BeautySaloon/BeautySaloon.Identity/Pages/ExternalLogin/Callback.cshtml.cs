...
namespace BeautySaloon.Identity.Pages.ExternalLogin;
[AllowAnonymous]
[SecurityHeaders]
public class Callback : PageModel
{
    ...
    public async Task<IActionResult> OnGet()
    {
        ...
        await _events.RaiseAsync(new UserLoginSuccessEvent(provider, providerUserId, user.Id, user.FullName, true, context?.Client.ClientId));
